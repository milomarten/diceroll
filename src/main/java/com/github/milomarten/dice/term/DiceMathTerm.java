 ...
 */
public sealed interface DiceMathTerm extends Term permits AbstractPoolTerm, CoinFlipTerm, ImplicitNumberTerm, NumberTerm, PlaceholderTerm, PredicateTerm, StringTerm, TokenTerm {
    /**
